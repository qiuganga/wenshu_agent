...
class MetaKnowledgeService:
    ...
    async def _save_tables_to_meta_db(self, meta_config: MetaConfig):
        ...
        for table in meta_config.tables or []:
            # Convert table config to TableInfoMySQL.
            table_info = TableInfoMySQL(id=table.name, name=table.name, role=table.role, description=table.description)
            ...
            for column in table.columns:
                ...
                # Convert column config to ColumnInfoMySQL.
