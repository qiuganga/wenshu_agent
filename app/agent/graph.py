...
graph_builder.add_node("security_validate_sql", security_validate_sql)
graph_builder.add_node("database_validate_sql", validate_sql)
...
graph_builder.add_conditional_edges(
    ...
    {
        "database_validate_sql": "database_validate_sql",
